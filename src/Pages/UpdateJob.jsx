        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
          ...
          <div className='create-job-flex'>
            <div className='lg:w-1/2 w-full'>
                ...
                <input type='Date' placeholder='Ex: 2024-4-10' defaultValue={"postingDate"}
          ...
          <div className='w-full'>
            <label className='block mb-2 tetx-lg'>Job Description</label>
            <textarea className="w-full pl-3 py-1.5 focus:outline-none placeholdertext-gray-700" rows={6} defaultValue={"description"} placeholder='Job Description' {...register("description")}/>
          </div>

          <div className='w-full'>
            <label className='block mb-2 tetx-lg'>Job Posted By</label>
